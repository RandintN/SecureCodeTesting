...
# peer chaincode invoke -o orderer.alphamed.com:7050 --tls --cafile /etc/hyperledger/crypto-config/ordererOrganizations/orderers/orderer.alphamed.com/tls/ca.crt -C n2medchannel -n med -c '{"Args":["addMedicineRequest","{\"amount\":\"23\", \"type\":\"donation\",\"medicine\":{\"active_ingredient\":\"AGUA\", \"pharma_form\":\"Xarope\", \"pharma_industry\":[\"3M\"],\"concentration\":\"33\", \"classification\":[\"Similar\"]},\"id\":\"13\" }"]}'
