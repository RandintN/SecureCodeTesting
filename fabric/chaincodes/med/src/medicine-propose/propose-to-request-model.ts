...
import { MedicineProposedRequest } from '../medicine-offered/medicine-proposed-request-model';
...
export class ProposeToRequest implements IValidator {
    ...
    public medicine: MedicineProposedRequest;
    public type: string;
    ...
    public fromJson(medicineOfferedRequestJson: IProposeToRequestJson): void {
        ...
        this.medicine = new MedicineProposedRequest();
