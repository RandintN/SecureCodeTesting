...
import { ProposeToOffer as ProposeToOffer } from './propose-to-offer-model';
import { IMedicineQueryKey } from '../medicine/medicine-query-key';
import { MedicineProposedDomainRequestExtras } from '../medicine-offered/medicine-offered-domain-request-extras';
...
export class MedicineProposeDomain implements IMedicineProposedService {
    ...
    private async validateOfferProposedMedicineRules(ctx: Context, medicineProposed: ProposeToOffer)
        ...
        try {
            ...
            const medicineProposedDomain: MedicineOfferedDomain = new MedicineOfferedDomain();
    ...
    private async validateRequestProposedMedicineRules(ctx: Context, medicineProposed: ProposeToRequest)
        ...
        try {
            ...
            const medicineProposedDomain: MedicineProposedDomainRequestExtras= new MedicineProposedDomainRequestExtras();
     ...
     */
    private validateProposedMedicine(proposedMedicine: MedicineOffered, originalMedicine: IMedicineRequestClaPharmIndJson): boolean {
