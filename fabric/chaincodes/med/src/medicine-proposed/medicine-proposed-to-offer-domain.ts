...
import { MedicineProposedToOffer } from './medicine-proposed-to-offer-model';

export class MedicineProposedToOfferDomain extends MedicineDomain {

    public async isValid(ctx: Context, medicine: MedicineProposedToOffer): Promise<ValidationResult> {
