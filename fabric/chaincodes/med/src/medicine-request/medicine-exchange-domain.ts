...
export class MedicineRequestExchangeDomain extends MedicineDomain {

    public async isValid(ctx: Context, medicine: MedicineRequestExchange): Promise<ValidationResult> {
    ...
    private async validateClassification(ctx: Context, medicine: MedicineRequestExchange):
    ...
    private async validatePharmaceuticalIndustries(ctx: Context, medicine: MedicineRequestExchange):
        Promise<ValidationResult> {
        const validationResult: ValidationResult = new ValidationResult();
